#!/bin/bash
# ============================================================
# ECHR data pipeline — Article 6
# Runs s1 → s2 → s3 → s4 → s5 for articles/art_6
#
# Submit with:
#   sbatch jobs/pipeline_art6.sh
# ============================================================
#SBATCH --job-name=echr_art6
#SBATCH --output=jobs/logs/art6_%j.out
#SBATCH --error=jobs/logs/art6_%j.err
...
echo "========================================"
echo "  ECHR Pipeline — Article 6"
echo "  Started: $(date)"
echo "========================================"

# ----------------------------------------------------------
# Step 1: Fetch raw metadata from HUDOC for Art. 6 queries
# ----------------------------------------------------------
